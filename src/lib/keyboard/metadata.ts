...
export const demoMetadata = keyboardMetadataSchema.parse({
  ...
  layout: {
    labels: ["Split Backspace", "ISO Enter", "Split R-Shift"],
    keymap: [
      [
        { key: 0 },
        { key: 1 },
      ...
      [
        ...
        { key: 42 },
        { key: 43 },
        { key: 44, w: 1.5, option: [1, 0] },
        { key: 65, x: 1, w: 1.25, h: 2, option: [1, 1] },
      ],
      [
        { key: 13, w: 1.75 },
        { key: 14 },
      ...
      [
        ...
        { key: 55 },
        { key: 56 },
        { key: 57, w: 2.75, option: [2, 0] },
        { key: 67, w: 1.75, option: [2, 1] },
        { key: 68, option: [2, 1] },
      ],
      [
        { key: 25, w: 1.5 },
